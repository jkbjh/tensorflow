...
TF_DOCKER_BUILD_ORIG_DOCKERFILE=${TF_DOCKER_BUILD_ORIG_DOCKERFILE:-"Dockerfile"}
...
echo "  TF_DOCKER_BUILD_ORIG_DOCKERFILE=${TF_DOCKER_BUILD_ORIG_DOCKERFILE}"
...
ORIG_DOCKERFILE=${TF_DOCKER_BUILD_ORIG_DOCKERFILE:-"Dockerfile"}
